  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed top-0 right-0 bottom-0 z-50 w-[min(82vw,360px)] bg-navy-900 border-l border-white/8 flex flex-col transform transition-transform duration-300 ease-in-out ${
