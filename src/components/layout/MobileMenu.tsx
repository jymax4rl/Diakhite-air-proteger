  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed top-0 right-0 bottom-0 z-50 h-full w-[min(85vw,380px)] flex flex-col bg-slate-900/80 backdrop-blur-2xl border-l border-white/10 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        {/* Nav links */}
        <nav
          className="flex-1 overflow-y-auto min-h-0 px-3 py-5"
